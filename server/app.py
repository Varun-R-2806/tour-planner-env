...
TASKS = [
    {
        "task_id": "task_1_easy",
        "difficulty": "easy",
        "description": "Plan a 2-day tour for a standard tourist using the search and booking API within a $500 budget.",
        "has_grader": True,
        "score_range": [0.0, 1.0],
    },
    {
        ...
        "difficulty": "medium",
        "description": "Plan a 3-day tour within a $1000 budget. You must manage temporal bookings to avoid schedule overlaps.",
        "has_grader": True,
        "score_range": [0.0, 1.0],
    },
    {
        "task_id": "task_3_hard",
        "difficulty": "hard",
        "description": "Plan a 5-day tour under strict persona constraints (e.g. disabled traveler) while avoiding bookings in bad weather events.",
        "has_grader": True,
        "score_range": [0.0, 1.0],
    },
]
